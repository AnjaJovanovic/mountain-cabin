...
userRouter.post("/updateProfilePicture", upload.single("profilePicture"), (request, response) => new user_controller_1.UserController().updateProfilePicture(request, response));
